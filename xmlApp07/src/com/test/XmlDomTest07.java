...
public class XmlDomTest07
{
   public static void main(String[] args)
   {
      try
      {
    	  ...
    	  // - XML 이나ㅣ HTML Document(문서) 를 응용프로그램에서 사용하기 위한 API 규격
    	  ...
    	  // - NodeList(NODESET)
    	  //   : 노드들을 리스트로 받아 처리하기 쉽도록 한 것( 일괄처리 )
    	  // - Document
         ...
         // 채널 안에 먼저 앞에 헤더 들이 있고 나머지 기사들 아이템으로 묶임
         ...
         Node linkNode = root.getElementsByTagName("link").item(0);
         ...
         Node copyrightNode = root.getElementsByTagName("copyright").item(0);
